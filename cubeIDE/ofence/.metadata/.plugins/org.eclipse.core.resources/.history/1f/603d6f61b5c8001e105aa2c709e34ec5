...
int main(void) {
	...
	void getIMU() {
		for (int i = 5; i >= 0; i--) {
			if (IMUdata[i] == 72) {
				IMUrev_number[0] = IMUdata[i + 1];
				IMUrev_number[1] = IMUdata[i + 2];
				break;
			}
		}
	...
	void getIR() {
		for (int i = 5; i >= 0; i--) {
			if (IRdata[i] == 72) {
				IRrev_number[0] = IRdata[i + 1];
				IRrev_number[1] = IRdata[i + 2];
				break;
			}
		}
	...
	void getLine() {
		for (int i = 5; i >= 0; i--) {
			if (Linedata[i] == 255) {
				Linerev_number[0] = Linedata[i + 1];
				Linerev_number[1] = Linedata[i + 2];
				break;
			}
		}
...
//			if (abs(IRAngle) < 20) {
//				Improveattitude(0);
//				Angle_Movesub(IRAngle, allpower/10 + 20);
//			} else {
//				Improveattitude(0);
//				Angle_Movesub(wrap_around(), allpower/10);
//			}
//		}
//			Improveattitude(0);
